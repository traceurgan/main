...
public class StatusBarFooter extends UiPart<Region> {
    ...
    @Subscribe
    public void handlePersonChangedEvent(PersonChangedEvent pce) {
        long now = clock.millis();
        String lastUpdated = new Date(now).toString();
        logger.info(LogsCenter.getEventHandlingLogMessage(pce, "Setting last updated status to " + lastUpdated));
