...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyPerson> initialDataSupplier = () -> null;
    protected String saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyPerson> initialDataSupplier, String saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializablePerson(this.initialDataSupplier.get()),
    ...
    public Model getModel() {
        Model copy = new ModelManager((model.getPartner()), model.getJournal(), new UserPrefs());
