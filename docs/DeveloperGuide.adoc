...
* may have to travel to unfamiliar locations in NUS
...
|`* * *` |user |encrypt my NUSCouples save data |prevent strangers from reading personal information such as my journal entries
