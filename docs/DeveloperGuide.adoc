...
* is currently a student of NUS
* is in a relationship with a student of NUS
* needs to remember special moments
* needs to remember special dates
* needs to schedule meetings
* needs to find a good time to meet
...
|`* * *` |new user |have commands that are intuitive and easy to remember |

|`* * *` |user who perfers typing over using the mouse |be able to control almost everything from the CLI |
...
|`* * *` |person in a relationship |add and view special events (e.g. Valentine's day) in the same month |better plan for these dates
