...
|Samuel (Journal)
|Allow couples to record their thoughts and feelings to remember the time spent with their partner
|Add/ delete tags to journal entries (happy, sad, angry, funny)
