...
|Chen Xing (Scheduler)
|This app allows user to schedule/edit/delete/view planned meetings
|This app allows user to receive notification about important dates from scheduled meetings

|Marlene (Timetable viewer)
|To help couples identify common breaks during school term so they can plan meetings during their free time
...
* Timetable viewer: To help couples identify common breaks during school term so they can plan meetings
* Scheduler: To schedule meetings and remind couples of planned meetings and important dates
* Journal: To record special memories
* Location: To help couples locate each other's classes so they can plan meetings near that area or meet them immediately after class
* Data encryption: To keep others from viewing personal information such as journal entries
...
|`* * *` |pair of NUS students in a relationship |view my partner's NUS timetable for the week |keep track of my partner's free time

|`* * *` |pair of NUS students in a relationship |replace my partner's NUS timetable |see the most updated timetable

|`* * *` |person in a relationship |add,edit,delete and view special events (e.g. Valentine's day) in the same month |better plan for these dates

|`* * *` |person in a relationship |schedule meetings with my partner |
...
4.  NUSCouples deletes the person
+
Use case ends.
...
.  A new user can have commands that are intuitive and easy to remember.
.  A user who prefers typing over using the mouse be able to control almost everything from the CLI.
