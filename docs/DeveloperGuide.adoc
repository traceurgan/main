...
* want to remember special moments
* want to remember special dates
...
* Timetable viewer: To help couples identify common breaks so they can plan meetings
* Scheduler: To remind couples of planned meetings and important dates
...
|`* * *` |NUS student in a relationship |view my partner's NUS timetable for the week |keep track of my partner's free time
...
|`* * *` |NUS student in a relationship |locate my partner from his NUS timetable |easily meet up with my partner on campus
