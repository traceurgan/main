...
|Daniel
|Location: To allow the user to find the venue of a particular lesson of interest from their own timetable using a
...
Send images via Google (optional): User could also specify that he/she wants to send a motivational image to their partner by
