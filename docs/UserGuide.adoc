...
=== Creating a new journal entry : `new`

Creates a new window that allows the user to input and save text. +
Format: `new` +
Alias: `n`

=== Scheduling new event : `schedule`
...
=== Showing partner's timetable : `timetable`

Shows the partner's timetable. +
Format: `timetable` +
Alias: `ttb`
