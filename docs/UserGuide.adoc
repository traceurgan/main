...
Alias: `ed INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [t/TAG]...`
...
=== Viewing a timetable : `tview`

Shows the current saved timetable. +
Format: `tview` +
Alias: `tv`

=== Adding a timetable : `tadd`

Imports a timetable from NUSMODS website. +
Format: `tadd` +
Alias: `ta`

=== Replacing a timetable : `treplace`

Replaces the current timetable with an updated version. +
Format: `treplace` +
Alias: `tr`
...
=== Filtering journal entries by date : `jfilter`

Filters journal entries by the specified internal. +
Format: `jfilter` +
Alias: `jf`

=== Viewing current calendar : `cview`

View Google calander. +
Format: `cview` +
Alias: `cv`

=== Adding new event to calendar : `cadd`

Adds new event to Google calander. +
Format: `cadd` +
Alias: `ca`
...
_{explain how the user can add two timetables and highlight time slots with common breaks}_
...
* *Undo* : `undo`
* *Redo* : `redo`
* *Timetable View* : `tview`
* *Timetable Add* : `tadd`
* *Timetable Replace* : `treplace`
* *Journal View* : `jview`
* *Journal New* : `jnew`
* *Journal Delete* : `jdelete`
* *Journal Filter* : `jfilter`
* *Calendar View* : `cview`
* *Calendar Add* : `cadd`
* *Calendar Delete* : `cdelete`
* *Calendar Edit* : `cedit`
* *Location* : `location`
